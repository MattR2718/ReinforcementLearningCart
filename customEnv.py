...
class blob:
	...
	#Subtract two blobs
	#Returns distance between both blobs
	#Use to get distance and direction to food and enemy
...
if start_q_table == None:
	q_table = {}
	#Two tuples (x1, y1)(x2, y2)
	#Distance to Food and Distance to enemy
